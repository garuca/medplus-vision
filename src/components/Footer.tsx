      ...
      <div className="mx-auto max-w-7xl glass-strong p-8 md:p-12">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-1">
            <img src={logo} alt="MedPlus Hospitalar" className="h-12 w-auto" width={140} height={48} />
            <p className="mt-4 text-sm text-muted-foreground">
              Tecnologia e confiança que cuidam da vida.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                <span>Av. Zoroastro Artiaga, QD 09 LT44 — Cruzeiro do Sul, Aparecida de Goiânia - GO, 74917-196</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="h-4 w-4 text-primary" />
                <a href="tel:+556235199974" className="hover:text-primary">(62) 3519-9974</a>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-2 border-t border-white/60 pt-6 text-xs text-muted-foreground md:flex-row">
          <p>© {new Date().getFullYear()} MedPlus Hospitalar Comércio e Serviços LTDA. Todos os direitos reservados.</p>
