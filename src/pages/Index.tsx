...
import { ArrowRight, Star, Truck, Shield, Headphones, Clock, ChevronRight, Activity, Baby, Dog, Bone, HeartPulse, GraduationCap, Microscope, AlertTriangle, Droplets, Zap, BadgeCheck, HeartHandshake, Briefcase, MapPin, CreditCard, MessageCircle, Wallet, Lock } from "lucide-react";
import heroImage from "../assets/hero-medical.jpg";
import bannerMedplus from "../assets/banner1-medplus.png";
import { products } from "../data/produtos";
import { useProdutos } from "../hooks/useProdutos";
import { DataSourceToggle } from "../components/DataSourceIndicator";
import cliente1 from "../assets/logos-clientes-medplus.png";
import cliente2 from "../assets/logos-clientes-medplus2.png";
import cliente3 from "../assets/logos-clientes-medplus3.png";
import cliente4 from "../assets/logos-clientes-medplus4.png";
import cliente5 from "../assets/logos-clientes-medplus5.png";
import cliente6 from "../assets/logos-clientes-medplus6.png";
import cliente7 from "../assets/logos-clientes-medplus7.png";
import cliente8 from "../assets/logos-clientes-medplus8.png";
import cliente9 from "../assets/logos-clientes-medplus9.png";
import cliente10 from "../assets/logos-clientes-medplus10.png";
import cliente11 from "../assets/logos-clientes-medplus11.png";
import cliente12 from "../assets/logos-clientes-medplus12.png";
import cliente13 from "../assets/logos-clientes-medplus13.png";
import cliente14 from "../assets/logos-clientes-medplus14.png";
import cliente15 from "../assets/logos-clientes-medplus15.png";
import cliente16 from "../assets/logos-clientes-medplus16.png";
import { SectionTitle } from "../components/SectionTitle";
import { useCart } from "../context/CartContext";

const categoriesMenu = [
  { slug: "urgencia-emergencia", nome: "Urgência e Emergência", icone: AlertTriangle, cor: "bg-red-100 text-red-600" },
  { slug: "sinais-vitais", nome: "Sinais Vitais", icone: HeartPulse, cor: "bg-rose-100 text-rose-600" },
  { slug: "diagnostico", nome: "Diagnóstico", icone: Microscope, cor: "bg-purple-100 text-purple-600" },
  { slug: "instrumentais-cirurgicos", nome: "Instrumentais Cirúrgicos", icone: Zap, cor: "bg-violet-100 text-violet-600" },
  { slug: "especialidades", nome: "Especialidades", icone: HeartHandshake, cor: "bg-indigo-100 text-indigo-600" },
  { slug: "area-do-academico", nome: "Área do Acadêmico", icone: GraduationCap, cor: "bg-blue-100 text-blue-600" },
  ...
  { slug: "cardiorespiratorio", nome: "Cardiorespiratório", icone: Activity, cor: "bg-orange-100 text-orange-600" },
  { slug: "limpeza-hospitalar", nome: "Limpeza Hospitalar", icone: Droplets, cor: "bg-teal-100 text-teal-600" },
  { slug: "ortopedia-reabilitacao", nome: "Ortopedia e Reabilitação", icone: Bone, cor: "bg-emerald-100 text-emerald-600" },
];

const clientLogos = [
  { id: 1, nome: "Cliente 1", imagem: cliente1 },
  { id: 2, nome: "Cliente 2", imagem: cliente2 },
  { id: 3, nome: "Cliente 3", imagem: cliente3 },
  { id: 4, nome: "Cliente 4", imagem: cliente4 },
  { id: 5, nome: "Cliente 5", imagem: cliente5 },
  { id: 6, nome: "Cliente 6", imagem: cliente6 },
  { id: 7, nome: "Cliente 7", imagem: cliente7 },
  { id: 8, nome: "Cliente 8", imagem: cliente8 },
  { id: 9, nome: "Cliente 9", imagem: cliente9 },
  { id: 10, nome: "Cliente 10", imagem: cliente10 },
  { id: 11, nome: "Cliente 11", imagem: cliente11 },
  { id: 12, nome: "Cliente 12", imagem: cliente12 },
  { id: 13, nome: "Cliente 13", imagem: cliente13 },
  { id: 14, nome: "Cliente 14", imagem: cliente14 },
  { id: 15, nome: "Cliente 15", imagem: cliente15 },
  { id: 16, nome: "Cliente 16", imagem: cliente16 },
];
...
const banners = {
  ...
  intermediario: { titulo: "Ofertas Especiais", subtitulo: "Até 30% de desconto em equipamentos médicos", botao: "Ver Ofertas" },
  grid: [
  ...
  footer: { titulo: "Precisa de ajuda?", descricao: "Nosso suporte está disponível 24/7", botao: "Falar no WhatsApp" },
};
          ...
          <div className="grid items-center gap-8 lg:grid-cols-2">
            <div className="relative z-10">
              ...
              <p className="mt-4 text-xl text-gray-600">
                {banners.hero.subtitulo}
              </p>
              <p className="mt-2 text-gray-500">
                {banners.hero.descricao}
              </p>
              <div className="mt-8">
                <Link to={banners.hero.link} className="group relative inline-flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-cyan-500 to-cyan-600 text-white font-semibold overflow-hidden shadow-lg shadow-cyan-500/30 hover:shadow-2xl hover:shadow-cyan-500/40 transition-all duration-300 hover:scale-105">
            ...
            <div className="relative">
              ...
              <div className="relative glass-card p-3 rounded-3xl shadow-2xl shadow-cyan-500/10">
                <div className="rounded-2xl overflow-hidden">
                  <img src={bannerMedplus} alt="MedPlus - Equipamentos Médicos" className="w-full h-auto" />
                </div>
              </div>
            ...
            <div className="flex animate-scroll gap-8">
              {[...clientLogos, ...clientLogos].map((cliente, idx) => (
                <div key={idx} className="flex-shrink-0 h-12 w-32 flex items-center justify-center">
                  <img src={cliente.imagem} alt={cliente.nome} className="h-full w-full object-contain opacity-70 hover:opacity-100 transition-opacity" />
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-500 via-blue-500 to-indigo-600 px-10 py-14 text-white shadow-2xl shadow-blue-500/25">
            ...
            <div className="relative z-10 grid items-center gap-10 lg:grid-cols-2">
              ...
              <div className="text-center lg:text-right">
                <Link to="/loja" className="group inline-flex items-center gap-3 rounded-2xl bg-white px-8 py-4 text-base font-bold text-blue-600 hover:bg-blue-50 transition-all hover:scale-105 hover:shadow-xl hover:shadow-white/20">
                  ...
                  <div className="mt-2">
                    {product.precoPromocional ? (
                      <>
                        ...
                        <div>
                          <span className="text-lg font-bold text-primary">R$ {product.precoPromocional.toFixed(2).replace(".", ",")}</span>
                          <span className="ml-1 text-xs text-green-600">à vista</span>
                        </div>
                        <span className="text-xs text-muted-foreground">ou {Math.ceil(product.precoPromocional / 2)}x de R$ {(product.precoPromocional / 2).toFixed(2).replace(".", ",")}</span>
                      </>
                    ) : (
      ...
      <section className="px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-6 md:grid-cols-2">
            <Link to="/loja" className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-600 px-10 py-12 text-white hover:shadow-2xl hover:shadow-purple-500/25 transition-all hover:scale-[1.02]">
              <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent"></div>
              ...
              <div className="relative z-10">
                <span className="inline-block rounded-full bg-white/20 backdrop-blur-sm px-3 py-1 text-xs font-medium mb-4">NOVO</span>
            ...
            <Link to="/loja" className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-orange-500 via-amber-500 to-yellow-500 px-10 py-12 text-white hover:shadow-2xl hover:shadow-orange-500/25 transition-all hover:scale-[1.02]">
              <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent"></div>
              <div className="absolute -right-16 -top-16 h-48 w-48 rounded-full bg-white/10 blur-3xl group-hover:scale-150 transition-transform"></div>
              <div className="absolute -bottom-8 -left-8 h-32 w-32 rounded-full bg-orange-400/20 blur-3xl"></div>
              <div className="relative z-10">
                <span className="inline-block rounded-full bg-white/20 backdrop-blur-sm px-3 py-1 text-xs font-medium mb-4">TOP</span>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 px-8 py-10 text-white">
            <div className="relative z-10 flex flex-col items-center text-center lg:flex-row lg:justify-between lg:text-left">
              ...
              <div className="mt-4 lg:mt-0">
                <a href="https://api.whatsapp.com/send/?phone=55556299981212" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full bg-cyan-500 px-8 py-4 text-sm font-semibold text-white hover:bg-cyan-600 transition">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-6 grid grid-cols-3 gap-4 sm:grid-cols-4 md:grid-cols-6">
            {categoriesMenu.map((cat) => {
              ...
              return (
                <Link key={cat.slug} to={`/loja/categoria/${cat.slug}`} className="group cursor-pointer">
                  <div className="glass-card flex flex-col items-center justify-center p-5 text-center hover:bg-white/80 transition-all group-hover:scale-105">
                    <div className={`flex h-14 w-14 items-center justify-center rounded-2xl ${cat.cor} mb-3 group-hover:scale-110 transition-transform`}>
                      <Icon className="h-7 w-7" strokeWidth={1.5} />
                    </div>
                    <span className="text-xs font-medium text-foreground/80 group-hover:text-foreground group-hover:font-semibold transition">{cat.nome}</span>
                  </div>
                </Link>
              );
            })}
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-600 via-blue-600 to-indigo-600 px-10 py-16 text-white text-center shadow-2xl shadow-blue-500/25">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-10 flex flex-wrap justify-center gap-4">
                <a href="https://api.whatsapp.com/send/?phone=55556299981212" target="_blank" rel="noreferrer" className="inline-flex items-center gap-3 rounded-2xl bg-white px-8 py-4 text-base font-bold text-blue-600 hover:bg-blue-50 transition-all hover:scale-105 hover:shadow-xl">
